...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改信息</strong> / <small>information</small></div>
        </div>
...
<%--                     <c:set value="${user}" var="user"/> --%>
                    <form class="am-form am-form-horizontal" id="information-form" action="${ctx}/updateOtherUser" method="post" data-am-validator>
